...
* Version            : V1.5
* Date               : 2024/7/26
* Description        : Nrf24L01 Si24R1 2.4G通信驱动库
*********************************************************************************
...
#define RF_INIT_CH			120	//射频信道(0~125)(原代码为60)
#define RF_INIT_DR			4	//数据速率(0:1M 1:2M 4:250k)
#define RF_INIT_PWR			7	//发射功率(0~7)

#define CHIP_CHECK_TIMES	5	//芯片检查次数(0为无穷次)
#define CHIP_CHECK_DELAY	100	//芯片检查延时(ms)
#define CHECK_MAX_TIMES_TX	20	//发送最大检查次数
#define CHECK_MAX_TIMES_RX	100	//接收最大检查次数

/* 调用函数定义 */
#define drv_spi_read_write_byte(Data)     CH549SPIMasterWrite(Data)	//SPI字节读写函数
#define Delay_ms(ms)                      mDelaymS(ms)				//ms延时函数
#define Delay_us(us)                      mDelayuS(us)				//us延时函数

/* RF24L01硬件接口定义 */
#define RF24L01_CE_GPIO_PORT		PORT4
#define RF24L01_CE_GPIO_PIN			PIN5
#define RF24L01_CE_GPIO_BIT			P4_5

#define RF24L01_CS_GPIO_PORT		PORT1
#define RF24L01_CS_GPIO_PIN			PIN4
#define RF24L01_CS_GPIO_BIT			P1_4

#define RF24L01_IRQ_GPIO_PORT		PORT4
#define RF24L01_IRQ_GPIO_PIN		PIN4
#define RF24L01_IRQ_GPIO_BIT		P4_4
...
uint8_t NRF24L01_check(void);//检查芯片在位
uint8_t NRF24L01_TxPacket( uint8_t *txbuf, uint8_t Length );
uint8_t NRF24L01_RxPacket( uint8_t *rxbuf );
void NRF24L01_Gpio_Init( void );//相关GPIO初始化
void RF24L01_Init( void );

//自行添加函数
void NRF24L01_TxStart(uint8_t *txbuf, uint8_t len);//启动发送
uint8_t NRF24L01_TxCheck(void);//检查发送
void NRF24L01_RxStart(void);//启动接收
uint8_t NRF24L01_RxPkg(uint8_t *rxbuf);//检查接收
void NRF24L01_Config(uint8_t ifRX);//初始化
